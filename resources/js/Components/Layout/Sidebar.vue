...
const menuItems = computed(() => {
    ...
    // Agregar opciones para admin o profesor
    ...
    if (page.props.auth.user?.tipo === 4) {
        ...
        return baseItems.filter(item => item.onlyAlumno || !item.hasOwnProperty('onlyAlumno'));
    } else {
            ...
            <div class="flex items-center space-x-3">
                ...
                >
                    <div v-show="sidebarOpen" class="flex flex-col">
                        <span class="text-sm font-bold text-white">IES Belgrano</span>
