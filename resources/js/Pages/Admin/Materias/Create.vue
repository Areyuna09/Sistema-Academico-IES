...
<template>
    <SidebarLayout :user="$page.props.auth.user">
        <template #header>
            <div>
                <h1 class="text-xl font-semibold text-white">Nueva Materia</h1>
                <p class="text-xs text-gray-400 mt-0.5">Crear una nueva materia</p>
            </div>
        </template>
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-200 mt-6">
                        ...
                        >
                            ...
                            {{ form.processing ? 'Guardando...' : 'Crear Materia' }}
                        </button>
                    </div>
                </form>
            </div>
